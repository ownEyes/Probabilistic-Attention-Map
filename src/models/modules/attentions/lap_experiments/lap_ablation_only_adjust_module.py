...
class lap_ablation_only_adjust_module(torch.nn.Module):
    def __init__(self, channels=None):
        super(lap_ablation_only_adjust_module, self).__init__()
    ...
    @staticmethod
    def get_module_name():
        return "lap_ablation_only_adjust"
